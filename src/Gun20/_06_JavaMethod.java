package Gun20;
 // hepsi ayni tip olursa kisa bir yontem var
public class _06_JavaMethod {
    ...
    // ... ile ilgili 2 kural var
     // 1- Bir metodda parametre olarak sadece 1 tane olabilir. // yani dizinin yaninda sadece bir string olur.
     // 2- Her zaman son parametre olmalı
     // gelen kaç sayı olursa olsun hepsini al dizi şeklinde metoda al

     public static int toplamBul(String isim, int...sayilar){  // kac sayi gelirse gelsin onlari dizi sekline aliyor // yanina ... koyuyoruz
        int toplam=0;                                          // ... ile olan her zaman sonda olmasi lazim en sagda
