...
public class _03_JavaDataTypes {
    public static void main(String[] args) {
        ...
        char basHarf = 'A';  // bir tane karakter saklayabilir. tek tirnak ile yailir.
        String isim = "ismet";  // kelime veya cümle saklayabilir. String de ki S buyuk yazilir. diger variables larda kucuk.
